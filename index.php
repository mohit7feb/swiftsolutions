		...
		<nav class="main-nav z-depth-0">
			<div class="nav-wrapper container-fluid">
				...
				<ul class="right">
					...
					<li><a href="#contact-us" class="btn yellow black-text semi-bold"><i class="material-icons right">keyboard_arrow_right</i>Let's Talk</a></li>
				</ul>
			</div>
		</nav>
		...
		<script>
			...
			window.onscroll = () => {
				if (document.documentElement.scrollTop > 50) {
					document.querySelector('.main-nav').classList.remove('z-depth-0')
				} else {
					document.querySelector('.main-nav').classList.add('z-depth-0')
				}
			}
		</script>
